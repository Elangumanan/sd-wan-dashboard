...
public final class DeviceDetailDto {
    ...
    public DeviceDetailDto(String id, String siteId, String name, String model,
                            DeviceStatus status, String ipAddress, String firmwareVersion,
                            String lastSeen, List<InterfaceDto> interfaces) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, siteId, name, model, status, ipAddress, firmwareVersion, lastSeen, interfaces);
    }
