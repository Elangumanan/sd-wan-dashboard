...
public final class SiteDetailDto {
    ...
    private final List<DeviceSummaryDto> devices;

    public SiteDetailDto(String id, String orgId, String name, String location,
        ...
        this.devices            = List.copyOf(Objects.requireNonNull(devices, "devices"));
    }
    ...
    public List<DeviceSummaryDto> devices()           { return devices; }

    @Override
    public boolean equals(Object o) {
        if (this == o) return true;
        if (!(o instanceof SiteDetailDto other)) return false;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, orgId, name, location, health, deviceCount,
                onlineDeviceCount, offlineDeviceCount, devices);
    }

    @Override
    public String toString() {
        return "SiteDetailDto[id=" + id + ", name=" + name + ", health=" + health
